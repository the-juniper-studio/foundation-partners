...
const BannerWithCaption = ({ slice }) => {
  ...
  return (
    <section className='component-banner_with_caption relative mx-auto md:my-6 w-full max-w-screen-xl grid md:grid-cols-2 px-3 md:px-6'>
      ...
      <div className='relative z-10 flex items-center p-6 md:p-12 bg-brandPeach dark:bg-white/10 '>
        <div
          className={`${
